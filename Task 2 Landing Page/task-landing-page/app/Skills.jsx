...
const Skills = () => {
  return (
    <>
    <div className="p-10 w-full min-h-screen bg-gradient-to-br from-rose-500 to-teal-500 flex flex-col items-center justify-center">
        <h1 className='text-5xl md:text-7xl font-bold text-center text-white mb-10'>Skills</h1>
